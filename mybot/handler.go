...
func HandleMessage(bot *tgbotapi.BotAPI, msg *tgbotapi.Message,
	...
	// ===============================================
	// 3. Сохраняем в БД (быстро, для логов)
	// ===============================================
	if db != nil {
	...
	// ===============================================
	// 5. Пересылаем оригинальное сообщение
	// ===============================================
	forwardMessage(bot, msg, forwardChatID)

	// ===============================================
	// 6. Отправляем лог в отдельный чат
	// ===============================================
